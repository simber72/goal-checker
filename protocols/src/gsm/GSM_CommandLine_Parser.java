...
public final class GSM_CommandLine_Parser extends AnBx_CommandLine_Parser<GSM_Roles,GSM_Channels> {

	public GSM_CommandLine_Parser(String[] args, String prot) {
		super(args, prot, prot, GSM_Roles.class, true);
	...
	protected void initProtocol() {
		...
		if (myAlias != null && keypath != null && sharepath != null) {
			switch (role) {
			case ROLE_B:
				GSM_pr = new GSM_Principal(myAlias, keypath, cs, aliases, false, crypto_config);
                GSM_pr.run(new GSM_ROLE_B(role, protname, sharepath), sessions);
				break;
			case ROLE_M:
				GSM_pr = new GSM_Principal(myAlias, keypath, cs, aliases, false, crypto_config);
                GSM_pr.run(new GSM_ROLE_M(role, protname, sharepath), sessions);
				break;
			case ROLE_H:
				GSM_pr = new GSM_Principal(myAlias, keypath, cs, aliases, false, crypto_config);
                GSM_pr.run(new GSM_ROLE_H(role, protname, sharepath), sessions);
				break;
