...
public final class GSM_S_2_Functions {
...
public static final byte[] trim(BigInteger n) {
	...
	public static SecretKey kc(AnB_Session s,Crypto_ByteArray par1,Crypto_ByteArray par2) {
		// TODO Auto-generated method stub
		
		return (SecretKey) s.getSymmetricKeyPBE(par1.toString()+par2.toString(),par2.toString()+par1.toString());
	}
