...
public final class AndrewSecureRPC_A_ROLE_A extends AnB_Protocol<AndrewSecureRPC_A_Steps,AndrewSecureRPC_A_Roles> {
...
//	private static boolean loop = false;
	...
	public AndrewSecureRPC_A_ROLE_A(AndrewSecureRPC_A_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
		...
		this.lbs = lbs;
		AndrewSecureRPC_A_ROLE_A.sessions = sessions;
        ...
        try {
            ...
            do {
                ...
                executeStep(ROLE_A_channel_ROLE_I_Client_Insecure, AndrewSecureRPC_A_Steps.STEP_0);
                executeStep(ROLE_A_channel_ROLE_I_Client_Insecure, AndrewSecureRPC_A_Steps.STEP_3);
                executeStep(ROLE_A_channel_ROLE_I_Client_Insecure, AndrewSecureRPC_A_Steps.STEP_4);
                executeStep(ROLE_A_channel_ROLE_I_Client_Insecure, AndrewSecureRPC_A_Steps.STEP_7);
