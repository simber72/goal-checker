...
public final class NSPK_ROLE_A extends AnB_Protocol<NSPK_Steps,NSPK_Roles> {
...
//	private static boolean loop = false;
	...
	public NSPK_ROLE_A(NSPK_Roles role, String name, String sharepath) {
		super();
		this.role = role;
		this.name = name;   
	...
	public void run(Map<String, AnB_Session> lbs, Map<String, String> aliases, long sessions) {
        ...
        try {
            ...
            do {
                ...
                executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, NSPK_Steps.STEP_0);
                executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, NSPK_Steps.STEP_1);
                executeStep(ROLE_A_channel_ROLE_B_Client_Insecure, NSPK_Steps.STEP_2);
	...
	protected void executeStep(AnB_Session s, NSPK_Steps step) {
        try {
            ...
            case STEP_1:
				...
				eqCheck("1.1",NxNA,(Crypto_ByteArray) VAR_A_DAR1INVPA.getValue(0));
